    ...
    <div className="px-4 md:px-8 lg:px-16 py-10 space-y-16">
      ...
      <header className="bg-blue-50 p-8 rounded-2xl shadow-md text-center">
        ...
        {!user ? (
          <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
            <button
              className="bg-blue-600 text-white py-2 px-6 rounded-xl cursor-pointer hover:bg-blue-700 transition duration-300"
              onClick={() => {
            ...
            <button
              className="bg-white border border-gray-300 text-gray-800 py-2 px-6 rounded-xl  cursor-pointer hover:bg-gray-100 transition duration-300"
              onClick={() => {
          ...
          <div className="mt-6 text-lg">
            ...
            {userType === 'USER' ? (
              <>
                ...
                <button
                  className="bg-blue-600 text-white py-2 px-6 cursor-pointer rounded-xl hover:bg-blue-700 transition duration-300"
                  onClick={() => navigate('/submit-complaint')}
                >
                  Submit New Complaint
                </button>
      ...
      {!user && (
        <section className="bg-blue-100 p-8 rounded-2xl text-center shadow-md">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button
              className="bg-blue-600 cursor-pointer text-white py-2 px-6 rounded-xl hover:bg-blue-700 transition duration-300"
              onClick={() => navigate('/citizen-login')}
            >
              Join as Citizen Reporter
            </button>
            <button
              className="bg-white border cursor-pointer border-gray-400 text-gray-800 py-2 px-6 rounded-xl hover:bg-gray-100 transition duration-300"
              onClick={() => navigate('/officer-login')}
            >
              Municipality Login
            </button>
